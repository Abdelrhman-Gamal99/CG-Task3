...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget.setGeometry(QtCore.QRect(30, 40, 721, 411))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.surface_button.sizePolicy().hasHeightForWidth())
        self.surface_button.setSizePolicy(sizePolicy)
        self.surface_button.setObjectName("surface_button")
        self.horizontalLayout_2.addWidget(self.surface_button)
        self.volume_button = QtWidgets.QPushButton(self.widget)
        ...
        self.horizontalLayout_2.addWidget(self.volume_button)
        ...
        self.menuOpen.addAction(self.actionNew_Folder)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.surface_button.setText(_translate("MainWindow", "Surface_Rendering"))
        self.volume_button.setText(_translate("MainWindow", "Volume_Rendering"))
